...
public class IOUContract implements Contract {
    public static final String ID = "com.template.contract.IOUContract";
    ...
    public void verify(LedgerTransaction tx) {
        ...
        final Party buyer = output.getBuyer();
        final Party seller = output.getSeller();
        ...
        final List<PublicKey> expectedSigners = Arrays.asList(buyer.getOwningKey(), seller.getOwningKey());
